...
def test_compute_partition_info_from_catalog(small_sky_dir, small_sky_source_dir, small_sky_source_pixels):
    ...
    assert partition_info.get_healpix_pixels() == small_sky_source_pixels
